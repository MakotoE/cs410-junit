...
public interface StringManipulationInterface {
	...
	/**
	 * Returns a string that consists of all characters in the original string except for the
	 * characters
	 ...
	 * <p>
	 * Examples:
	 * - For n=2 and maintainSpacing=false, the method would return the string without the 2nd,
     * 4th,
	 * 6th, and so on characters in the string.
	 * - For n=3 and maintainSpacing=true, the method would return the string with a space
     * replacing
	 * the 3nd, 6th, 9th, and so on characters in the string.
	 * <p>
	 * Values n and maintainSpacing are passed as parameters. The starting character is
	 ...
	 * @param maintainSpacing Determines whether replace the missing characters with a space, in
	 *                        order
	 *                        to maintain the length of the original string.
	 * @return String made of characters at positions other than n, 2n, and so on in the current
	 * string
	 */
	 ...
	 * All values of indices are unique (i.e. indices is a permutation of the integers from 0 to
	 * n - 1).
